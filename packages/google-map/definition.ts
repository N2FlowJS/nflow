  ...
  config: {
    properties: {
      ...
      action: {
        type: 'string',
        title: 'Action',
        description: 'Maps operation to perform',
        enum: ['geocode', 'reverse_geocode', 'directions', 'places_search', 'place_details', 'distance_matrix'],
        default: 'geocode',
        required: true
      },
      address: {
        type: 'string',
        title: 'Address',
        description: 'Address for geocoding (supports {variable} templates)',
        required: false
      },
      latitude: {
        type: 'number',
      ...
      origin: {
        type: 'string',
        title: 'Origin',
        description: 'Origin location (supports {variable} templates)',
        required: false
      },
      destination: {
        type: 'string',
        title: 'Destination',
        description: 'Destination location (supports {variable} templates)',
        required: false
      },
      travelMode: {
        type: 'string',
      ...
      query: {
        type: 'string',
        title: 'Search Query',
        description: 'Search query for places (supports {variable} templates)',
        required: false
      },
      radius: {
        type: 'number',
      ...
      placeId: {
        type: 'string',
        title: 'Place ID',
        description: 'Place ID for details',
        required: false
      }
    }
  },
