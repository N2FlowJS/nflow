...
export interface GoogleMapForm extends BaseForm {
  ...
  apiKey?: string; // optional until validation time
  address?: string;
  latitude?: string;
  longitude?: string;
  origin?: string; // single or comma separated (distance matrix)
  destination?: string; // single or comma separated (distance matrix)
