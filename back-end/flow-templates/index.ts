...
type SchemaField = NonNullable<NodeData['configSchema']>[number];
...
const withValues = (
  ...
  const next = schema.map((field: SchemaField) => ({ ...field }));
  Object.entries(values).forEach(([name, value]) => {
    const index = next.findIndex((field: SchemaField) => field.name === name);
    if (index >= 0) {
...
const FLOW_TEMPLATES_RAW: FlowTemplate[] = [
  ...
  },
  {
    ...
    data: {
      ...
      edges: [
        { id: 'tmpl4-e-llm', source: 'tmpl4-model', target: 'tmpl4-agent', targetHandle: 'agent_llm', type: 'cyberEdge', animated: true, style: { stroke: '#a855f7', strokeWidth: 1.5 } },
        { id: 'tmpl4-e-input', source: 'tmpl4-input', target: 'tmpl4-agent', targetHandle: 'input_value', type: 'cyberEdge', animated: true, style: { stroke: '#22c55e', strokeWidth: 1.5 } },
        { id: 'tmpl4-e-system', source: 'tmpl4-prompt', target: 'tmpl4-agent', targetHandle: 'system_prompt', type: 'cyberEdge', style: { stroke: '#64748b', strokeWidth: 1.5 } },
        { id: 'tmpl4-e-tool', source: 'tmpl4-sql', sourceHandle: 'as_tool', target: 'tmpl4-agent', targetHandle: 'tools', type: 'cyberEdge', style: { stroke: '#f59e0b', strokeWidth: 1.5, strokeDasharray: '5,5' } },
        { id: 'tmpl4-e-output', source: 'tmpl4-agent', sourceHandle: 'response', target: 'tmpl4-output', type: 'cyberEdge', animated: true, style: { stroke: '#22d3ee', strokeWidth: 1.5 } },
      ],
  ...
  },
  {
    ...
    data: {
      ...
      edges: [
        { id: 'tmpl5-e-llm', source: 'tmpl5-model', target: 'tmpl5-agent', targetHandle: 'agent_llm', type: 'cyberEdge', animated: true, style: { stroke: '#a855f7', strokeWidth: 1.5 } },
        { id: 'tmpl5-e-input', source: 'tmpl5-input', target: 'tmpl5-agent', targetHandle: 'input_value', type: 'cyberEdge', animated: true, style: { stroke: '#22c55e', strokeWidth: 1.5 } },
        { id: 'tmpl5-e-system', source: 'tmpl5-prompt', target: 'tmpl5-agent', targetHandle: 'system_prompt', type: 'cyberEdge', style: { stroke: '#64748b', strokeWidth: 1.5 } },
        { id: 'tmpl5-e-emb', source: 'tmpl5-embedding', target: 'tmpl5-es', targetHandle: 'embedding_model', type: 'cyberEdge', style: { stroke: '#3b82f6', strokeWidth: 1.5 } },
        { id: 'tmpl5-e-tool', source: 'tmpl5-es', sourceHandle: 'as_tool', target: 'tmpl5-agent', targetHandle: 'tools', type: 'cyberEdge', style: { stroke: '#f59e0b', strokeWidth: 1.5, strokeDasharray: '5,5' } },
        { id: 'tmpl5-e-output', source: 'tmpl5-agent', sourceHandle: 'response', target: 'tmpl5-output', type: 'cyberEdge', animated: true, style: { stroke: '#22d3ee', strokeWidth: 1.5 } },
      ],
  ...
  },
  {
    ...
    data: {
      ...
      edges: [
        { id: 'tmpl6-e-llm', source: 'tmpl6-model', target: 'tmpl6-agent', targetHandle: 'agent_llm', type: 'cyberEdge', animated: true, style: { stroke: '#a855f7', strokeWidth: 1.5 } },
        { id: 'tmpl6-e-input', source: 'tmpl6-input', target: 'tmpl6-agent', targetHandle: 'input_value', type: 'cyberEdge', animated: true, style: { stroke: '#22c55e', strokeWidth: 1.5 } },
        { id: 'tmpl6-e-system', source: 'tmpl6-prompt', target: 'tmpl6-agent', targetHandle: 'system_prompt', type: 'cyberEdge', style: { stroke: '#64748b', strokeWidth: 1.5 } },
        { id: 'tmpl6-e-tool', source: 'tmpl6-http', sourceHandle: 'as_tool', target: 'tmpl6-agent', targetHandle: 'tools', type: 'cyberEdge', style: { stroke: '#f59e0b', strokeWidth: 1.5, strokeDasharray: '5,5' } },
        { id: 'tmpl6-e-output', source: 'tmpl6-agent', sourceHandle: 'response', target: 'tmpl6-output', type: 'cyberEdge', animated: true, style: { stroke: '#22d3ee', strokeWidth: 1.5 } },
      ],
      viewport: { x: 0, y: 0, zoom: 0.8 },
    },
  },
